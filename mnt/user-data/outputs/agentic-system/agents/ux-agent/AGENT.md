...
name: ux-agent
description: |
  Senior UX Designer агент для Design фазы.
  Использовать когда: нужно создать User Flows, Information Architecture, 
  Wireframes, CJM, Accessibility requirements.
  Работает в паре с UI Agent для полного дизайн-процесса.
---
