...
name: qa-agent
description: |
  Senior QA Engineer / SDET агент.
  Использовать когда: нужно создать test strategy, test plan, 
  test cases, настроить тестовую инфраструктуру, запустить тесты.
  Работает с Docker для тестовых окружений.
---
