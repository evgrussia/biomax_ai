...
name: research-agent
description: |
  Senior Market Research Analyst агент для Discovery фазы.
  Использовать когда: нужно провести исследование рынка, анализ конкурентов, 
  изучение целевой аудитории, технологический анализ.
  Использует веб-поиск для сбора актуальной информации.
---
