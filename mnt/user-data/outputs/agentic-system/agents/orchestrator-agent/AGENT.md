...
description: |
  Главный агент-оркестратор системы разработки веб-приложений.
  Использовать когда: получена новая бизнес-идея или задача на разработку веб-приложения.
  Отвечает за: декомпозицию задач, маршрутизацию к субагентам, мониторинг прогресса,
  управление контекстом и обеспечение консистентности между всеми этапами разработки.
---
