...
description: |
  Claude-based агент-разработчик для реализации кода по техническим спецификациям.
  Альтернатива Cursor Agent. Использовать когда: нужно реализовать фичу по готовой 
  технической спецификации через Claude, написать код, создать тесты, исправить баги.
