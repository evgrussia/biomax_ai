...
description: |
  Senior Marketing Manager / Growth Strategist агент.
  Использовать когда: проект готов к запуску и нужно создать 
  маркетинговую стратегию, план продвижения, контент-план.
---
