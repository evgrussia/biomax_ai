...
name: ui-agent
description: |
  Senior UI Designer агент для Design фазы.
  Использовать когда: нужно создать Design System, UI Kit, Visual Design,
  Component Library specifications, Style Guide.
  Работает в паре с UX Agent и использует Image Generator skill для создания графики.
---
