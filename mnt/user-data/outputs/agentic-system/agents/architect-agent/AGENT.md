...
description: |
  Senior/Lead Software Architect агент для Architecture фазы.
  Использовать когда: нужно спроектировать архитектуру системы, 
  создать ADRs, диаграммы C4, определить NFRs, выбрать технологический стек.
