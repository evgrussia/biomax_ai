...
name: product-agent
description: |
  Senior Product Manager агент для Discovery фазы.
  Использовать когда: нужно создать продуктовую документацию - Vision, PRD, User Stories, Roadmap.
  Создаёт документацию уровня Senior PM в соответствии с лучшими практиками продуктовой разработки.
---
