...
description: |
  Навык генерации изображений для проекта.
  Использовать когда: нужно создать графику, иллюстрации, иконки,
  hero images, backgrounds для дизайна интерфейса или контента.
---
